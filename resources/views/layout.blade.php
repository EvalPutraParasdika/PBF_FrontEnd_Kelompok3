...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tables @yield('judul')</h1>
                    <!-- DataTales Example -->
                    <div id="content">
                      <main>
                        @yield('isi')
    ...
    <!-- Core plustartbootstrap-sb-admin-2-gh-pages/gin JavaScript-->
    <script src="startbootstrap-sb-admin-2-gh-pages/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom sstartbootstrap-sb-admin-2-gh-pages/cripts for all pages-->
    <script src="startbootstrap-sb-admin-2-gh-pages/js/sb-admin-2.min.js"></script>

    <!-- Page levstartbootstrap-sb-admin-2-gh-pages/el plugins -->
    ...
    <!-- Page levstartbootstrap-sb-admin-2-gh-pages/el custom scripts -->
